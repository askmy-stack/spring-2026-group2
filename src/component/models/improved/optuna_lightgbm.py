...
def build_lgb_params(trial: optuna.Trial, base_params: dict) -> dict:
...
def main() -> None:
    ...
    def objective(trial: optuna.Trial) -> float:
        params = build_lgb_params(trial, base_params)
    ...
    logging.info("Retraining best LightGBM model on train split...")
    ...
    best_model.booster_.save_model(str(models_dir / "model.txt"))
    logging.info("Saved tuned LightGBM outputs to %s", output_dir)
    logging.info("Done.")
